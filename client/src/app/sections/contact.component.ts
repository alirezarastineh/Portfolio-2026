...
@Component({
  ...
  template: `
    <section id="contact" class="relative px-6 py-24 sm:px-8 sm:py-28 lg:px-12 lg:py-32">
      <div class="mx-auto flex max-w-150 flex-col gap-10">
        ...
        @if (state() === "success") {
          ...
          >
            ...
            @if (state() === "error" && errorMsg()) {
              <p class="m-0 font-mono text-sm text-destructive" role="alert" aria-live="polite">
                {{ errorMsg() }}
              </p>
            }
